			...
			<Stack>
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Text as="p" margin="6px 0" font="--headline3">
							<Link href="ethan.gers1@gmail.com" text-decoration="none" hover-text-decoration="underline" color="--light">
								ethan.gers1@gmail.com
							</Link>
						</Text>
					</Box>
				</StackItem>
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Formspree endpoint="https://formspree.io/f/mvovearl" completeText="Success! Ethan will be back with you in no time." errorMessage="Uh oh, it seems there's been an error. Try again.">
							<Stack gap="16px">
								<StackItem width="100%">
									<Override slot="StackItemContent" flex-direction="column" />
